 ...
 * @author graba
 */
public class addPetPane extends javax.swing.JPanel {
    int id = 0;
    /**
     * Creates new form addPetPane
     */
    public addPetPane(int id) {
        initComponents();
        this.id = id;
    }
    ...
    private void initComponents() {
        ...
        jButton1.setText("Añadir mascota");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            // TODO add your handling code here:
            Pet addedPet = new Pet(jTextField1.getText(),jTextField2.getText(),Integer.parseInt(jTextField3.getText()),jTextField4.getText(),this.id);
            addedPet.addPet();
        } catch (NoSuchAlgorithmException ex) {
            Logger.getLogger(addPetPane.class.getName()).log(Level.SEVERE, null, ex);
        }
